/* AUTO-GENERATED from tennis-scorer.jsx — edit the .jsx and recompile. */
const {
  useState
} = React;
...
function tbParams(s) {
  if (isSuperTbSet(s)) return {
    target: 10,
    winByTwo: true,
    isSet: true
  };
  // deciding set played to a 10-point tiebreak at 6–6 (modern Grand Slam / pro)
  if (s.config.decidingSet === "tb10at66" && isDecidingSet(s)) return {
    target: 10,
    winByTwo: true,
    isSet: false
  };
  if (s.config.setFormat === "fast4") return {
    target: 5,
    winByTwo: false,
    isSet: false
  };
...
function winGame(s, p) {
  ...
  if (g[p] >= need && g[p] - g[o] >= 2) return winSet(s, p, {
    games: [...g]
  });
...
const setLabel = {
  regular6: "Regular 6",
  advSet: "Advantage Set",
  pro: "Pro Set (8)",
  fast4: "Fast4",
  superTb: "Super Tiebreak (10)"
};
...
function Setup({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    style: lbl
  }, "First Serve"), /*#__PURE__*/React.createElement(Segment, {
    accent: C.ball,
    value: firstServer,
    ...
    style: lbl
  }, "Match"), /*#__PURE__*/React.createElement(Segment, {
    accent: C.ball,
    value: matchFormat,
    ...
    style: lbl
  }, "Set Format"), /*#__PURE__*/React.createElement(Segment, {
    accent: C.ball,
    value: setFormat,
  ...
  }, setFormat === "regular6" && "First to 6 games, win by 2. Tiebreak (to 7) at 6–6.", setFormat === "advSet" && "First to 6 games, win by 2. No tiebreak — the set is played out.", setFormat === "pro" && "First to 8 games, win by 2. Tiebreak (to 7) at 8–8.", setFormat === "fast4" && "First to 4 games, No-AD. Tiebreak (to 5) at 3–3.", setFormat === "superTb" && "Each set is a 10-point match tiebreak, win by 2.")), showAd && /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("span", {
    style: lbl
  }, "Game Scoring"), /*#__PURE__*/React.createElement(Segment, {
    accent: C.ball,
    value: adType,
    onChange: setAdType,
    options: [{
  ...
  })), showDecider && /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("span", {
    style: lbl
  }, "Deciding Set"), /*#__PURE__*/React.createElement(Segment, {
    accent: C.ball,
    value: decidingSet,
    onChange: setDecidingSet,
    options: [{
      v: "standard",
      t: "Standard"
    }, {
  ...
  }, decidingSet === "standard" && "Final set is played like the others.", decidingSet === "tb10at66" && "Final set: at 6–6, play a 10-point tiebreak (modern Grand Slam / pro).", decidingSet === "matchTb10" && "Final set is replaced by a 10-point match tiebreak (junior / doubles).")), /*#__PURE__*/React.createElement("button", {
    onClick: () => onStart({
      matchFormat,
      setFormat,
      adType,
      decidingSet,
      firstServer
    }, [n1.trim() || "Player 1", n2.trim() || "Player 2"]),
    style: {
      marginTop: 4,
      padding: "16px",
      cursor: "pointer",
      ...
      fontSize: 26,
      letterSpacing: 2,
      boxShadow: "0 8px 24px rgba(102,126,234,.22)"
    }
  }, "START MATCH"));
}
function PlayerRow({
  ...
  return /*#__PURE__*/React.createElement("button", {
    ...
    style: {
      ...
      border: `1.5px solid ${won ? accent : C.line}`,
    ...
    style: {
      ...
      border: serving ? "none" : `1.5px solid ${C.line}`
    }
  }), /*#__PURE__*/React.createElement("span", {
    style: {
      fontFamily: "system-ui,-apple-system,'Segoe UI',sans-serif",
  ...
  }, s.names[p]), side && /*#__PURE__*/React.createElement("span", {
    title: side === "deuce" ? "Deuce court (right)" : "Ad court (left)",
    style: {
      fontSize: 12,
      fontWeight: 800,
      color: accent,
  ...
  }, side === "deuce" ? "R" : "L"), won && /*#__PURE__*/React.createElement(Trophy, {
    size: 20,
    color: accent,
    style: {
      flexShrink: 0
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      style: {
        ...
        fontSize: 33,
        lineHeight: 1,
        color: w ? C.chalk : C.muted
      }
    }, val), set.tb && set.type !== "superTb" && /*#__PURE__*/React.createElement("sup", {
      style: {
        fontFamily: "system-ui,-apple-system,'Segoe UI',sans-serif",
        fontSize: 10,
        color: C.muted,
  ...
  }), !s.done && s.config.setFormat !== "superTb" && /*#__PURE__*/React.createElement("span", {
    style: {
      fontFamily: "system-ui,-apple-system,'Segoe UI',sans-serif",
      fontSize: 40,
      lineHeight: 1,
  ...
  }, s.games[p])), /*#__PURE__*/React.createElement("div", {
    style: {
      minWidth: 78,
      textAlign: "center"
    }
    ...
    style: {
      ...
      fontWeight: 700,
      lineHeight: 0.8,
      color: ad || s.inTiebreak && !s.done ? accent : C.chalk
    }
  }, pt)));
}
function Scoreboard({
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, [fmtLabel[s.config.matchFormat], setLabel[s.config.setFormat], s.config.setFormat === "fast4" ? "No-AD" : s.config.setFormat === "superTb" ? null : s.config.adType === "ad" ? "AD" : "No-AD", s.config.decidingSet === "matchTb10" ? "Final: Match TB10" : s.config.decidingSet === "tb10at66" ? "Final: 6–6 TB10" : null].filter(Boolean).map((t, i) => /*#__PURE__*/React.createElement("span", {
    key: i,
    style: {
      fontFamily: "system-ui,-apple-system,'Segoe UI',sans-serif",
      fontSize: 10.5,
  ...
  }, /*#__PURE__*/React.createElement("span", null, "Player \xB7 Sets ", s.setsWon[0], "\u2013", s.setsWon[1], " \xB7 first to ", stw), /*#__PURE__*/React.createElement("span", {
    style: {
      display: "flex",
      gap: 30
    }
  }, /*#__PURE__*/React.createElement("span", null, s.config.setFormat === "superTb" ? "TB" : "Games"), /*#__PURE__*/React.createElement("span", null, "Point"))), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      flexDirection: "column",
      gap: 14
  ...
  }, "\uD83C\uDFBE ", s.names[s.winner], " wins the match") : /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("span", {
    style: {
      fontSize: 13,
      fontWeight: 800,
      letterSpacing: 1,
      ...
      padding: "6px 14px",
      opacity: notice ? 1 : 0,
      maxHeight: notice ? 34 : 0,
      overflow: "hidden",
      transition: "opacity .5s ease, max-height .4s ease",
      pointerEvents: "none"
    }
  }, "\uD83D\uDD04 Change ends"), side && /*#__PURE__*/React.createElement("span", {
    style: {
      fontSize: 13.5,
      fontWeight: 700,
      color: C.muted
    ...
    style: {
      color: s.server === 0 ? C.ball : C.clay
    }
  }, s.names[s.server]), " to serve \xB7", " ", side === "deuce" ? "Deuce court (right)" : "Ad court (left)"), banner && /*#__PURE__*/React.createElement("span", {
    style: {
      fontSize: 14,
      fontWeight: 800,
      letterSpacing: 2,
...
function TennisScorer() {
  ...
  const start = (config, names) => {
    clearNotice();
    setMatch(initState(config, names));
    setHistory([]);
  };
  const point = p => {
    setHistory(h => [...h, match]);
    setMatch(m => applyPoint(m, p));
  };
  const undo = () => {
